...
abstract class XmlPullNodeParser<R> {
	...
	/**
	 * Call {@link com.handmark.pulltorefresh.configuration.xml.XmlPullNode.XmlPullNodeCallback#process(org.xmlpull.v1.XmlPullParser)} and parse child nodes of current node
	 * 
