 ...
 * If you implement {@link com.handmark.pulltorefresh.configuration.xml.XmlPullNode#XmlPullNodeCallback} and pass that on to this class,<br /> {@link XmlPullNodeParser} calls {@link com.handmark.pulltorefresh.configuration.xml.XmlPullNode#XmlPullNodeCallback#process(org.xmlpull.v1.XmlPullParser)} when it has found this current node during parse.<br />
...
class XmlPullNode {
	 ...
	 * 
	 * NOTE: If you implement {@link com.handmark.pulltorefresh.configuration.xml.XmlPullNode#XmlPullNodeCallback} and pass that on to {@code XmlPullNode} class,<br /> {@link XmlPullNodeParser} calls {@link com.handmark.pulltorefresh.configuration.xml.XmlPullNode#XmlPullNodeCallback#process(org.xmlpull.v1.XmlPullParser)} when it has found this the node during parse.
	 * @author Wonjun Kim
	 *
	 */
	...
	private static class XmlPullNodeContainer {
		 ...
		 * @throws org.xmlpull.v1.XmlPullParserException if a number of repetitions reaches the limit
		 */
