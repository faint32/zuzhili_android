 ...
 * This Class is Singleton, and you <b>MUST</b> call {@link #init(android.content.Context)} before using this class.
 * @author Wonjun Kim
 */
public class PullToRefreshXmlConfiguration {
	...
	/**
	 * flag whether it has called {@link #init(android.content.Context)}
	 */
	...
	/**
	 * @return true if {@link #init(android.content.Context)} method has not been called
	 */
	private boolean notInitialized() {
		return !initialized;
	}
	/**
	 * @return throw an exception if {@link #init(android.content.Context)} method has not been called
	 */
