...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	/**
	 * <p>
	 * Indicator Layout Class Token <br /> {@link com.handmark.pulltorefresh.library.IndicatorLayoutFactory} will create instances by using this class token.
	 * The token must not be null. {@link IndicatorLayoutFacoty} ensures that class token exists always.
	 * Assignment some class token into this variable is implemented at {@link #handleStyledAttributes(android.content.res.TypedArray)}.
	 * </p>
	 */
