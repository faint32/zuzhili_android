...
public abstract class AbstractDefaultGoogleStyleViewLayout extends GoogleStyleViewLayout {
	 ...
	 * If text color is not set, set default color by calling {@link #getDefaultTextColor(android.content.Context, android.content.res.TypedArray)}, or {@link #getDefaultSubTextColor(android.content.Context, android.content.res.TypedArray)}.<br />
	 * Also, if background color is not set, set default color by calling {@link #getDefaultBackgroundColor(android.content.Context, android.content.res.TypedArray)}
	 * @param context
	 * @param attrs
	 */
