...
public class IMChatMessageDetail extends InstanceMsg {
    ...
    private String identityId;          // identity id
    private String q_fileurl;            //七牛上保存的文件地址
    ...
    public String getQ_fileurl() {
        return q_fileurl;
    }

    public void setQ_fileurl(String q_fileurl) {
        this.q_fileurl = q_fileurl;
    }
	...
	public static IMChatMessageDetail getGroupItemMessage(int textOrFile  , int imState , String sessionId, String sender, String userData) {
		IMChatMessageDetail chatMessageDetail = new IMChatMessageDetail();
		chatMessageDetail.setCurDate(String.valueOf(System.currentTimeMillis()));
