 ...
 */
public class PersonalSpaceFrg extends FixedOnActivityResultBugFragment implements Response.Listener<String>, Response.ErrorListener
    ...
    public static PersonalSpaceFrg newInstance(Serializable serializable) {
        PersonalSpaceFrg f = new PersonalSpaceFrg();
