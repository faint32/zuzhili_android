...
package com.zuzhili.ui.actionbar;
...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    private void setupActionBar() {
        ...
        LinearLayout.LayoutParams titleLayoutParams = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT);
        titleLayoutParams.weight = 1;
        titleLayoutParams.leftMargin = 190;
        ...
        Drawable drawable = mActivity.getResources().getDrawable(R.drawable.drop_down);  
